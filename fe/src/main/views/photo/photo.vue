...
<template>
    <div class="photo">
        <img :src="`http://localhost:3000/api/filters/getimage/${this.id}`" alt="imag">
    ...
    <div class="filters">
        <ul>
            ...
            <li @click="reformatForm = !reformatForm"  >reformat</li>
            <li v-if="reformatForm" class="form">
                <select v-model="format" name="format" id="">
                    <option value="png">png</option>
                    <option value="jpg">jpg</option>
                </select>

                <button @click="send('reformat')"class="sendReformat" type="submit">send</button>
            </li>
